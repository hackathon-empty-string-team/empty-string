...
class AudioDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print(f"log_mel_spectrogram shape before framing: {log_mel_spectrogram.shape}")
        ...
        # print(f"log_mel_examples shape after framing: {log_mel_examples.shape}")
        ...
        # print(f"log_mel_examples shape after unsqueeze: {log_mel_examples.shape}")
