...
def extract_features(file_path, model, device, target_height=64, target_width=96):
    ...
    # Add batch and example dimensions
...
encoded_features = extract_features(file_path, model, device)
